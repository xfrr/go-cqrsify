...
func main() {
	...
	def := &saga.Definition{
		...
		Steps: []saga.Step{
			{
				Name:                     "create_order",
				Action:                   saga.MessagingRemoteAction(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.order.reserve.cmd", Compensate: "cqrsify.examples.sagas.order.reserve.compensate.cmd", Timeout: 5 * time.Second}),
				Compensate:               saga.MessagingRemoteCompensation(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.order.reserve.cmd", Compensate: "cqrsify.examples.sagas.order.reserve.compensate.cmd", Timeout: 5 * time.Second}),
			...
			},
			{
				...
				Action:                   saga.MessagingRemoteAction(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.payment.charge.cmd", Compensate: "cqrsify.examples.sagas.payment.refund.cmd", Timeout: 15 * time.Second}),
				Compensate:               saga.MessagingRemoteCompensation(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.payment.charge.cmd", Compensate: "cqrsify.examples.sagas.payment.refund.cmd", Timeout: 15 * time.Second}),
			...
			},
			{
				...
				Action:                   saga.MessagingRemoteAction(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.inventory.reduce.cmd", Compensate: "cqrsify.examples.sagas.inventory.restore.cmd"}),
				Compensate:               saga.MessagingRemoteCompensation(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.inventory.reduce.cmd", Compensate: "cqrsify.examples.sagas.inventory.restore.cmd"}),
			...
			{
				Name:          "deliver_order",
				Action:        saga.MessagingRemoteAction(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.delivery.ship.cmd", Compensate: "cqrsify.examples.sagas.delivery.cancel.cmd"}),
				Compensate:    saga.MessagingRemoteCompensation(cmdBus, saga.RemoteSubjects{Action: "cqrsify.examples.sagas.delivery.ship.cmd", Compensate: "cqrsify.examples.sagas.delivery.cancel.cmd"}),
