...
const streamName = "cqrsify_query_bus_example"
...
func main() {
	...
	unsub, err := messaging.RegisterQueryHandler(ctx, queryBus, messaging.MessageHandlerWithReplyFn[GetOrderAmountQuery, getOrderAmountQueryReply](func(ctx context.Context, query GetOrderAmountQuery) (getOrderAmountQueryReply, error) {
